...
<div style="width: 90%; margin-left: 5%; margin-right: 5%; align-items: center; align-self: center; align-content: center; " align="center" class="card1">
  <div class="container" style="width: 45%; float: left; background-color: #e6edec; border-radius: 15px; margin: 15px; padding: 30px; align-items: center;" class="card1">
    ...
    {
      echo "NO subjects selected yet";
    }
    else  {
          echo "Subjects you are interested in teaching:";
          echo "<p align='center'>";
  ...
  ?>
    ...
    echo"<select multiple='multiple' name='ai[]' size='".$c."'>";
      ...
      ?>
      <br>
      <button name="submit" class="button"><big>Add </big></button>
      </form>
      <br><br>
    </div>
      ...
      <?php
       ...
       $result = mysqli_query($mysqli,$qer);
        ...
        while ($row = mysqli_fetch_assoc($result)) 
          ...
          echo "</select>";
      ?>
<br> <button name="submit" class ="button"><big>Remove</big></button>
</form>
<br><br>
    </div>
  ...
  <form method="post" action="update_studentinfo.php?pd=<?php echo $pd; ?>">
    ...
    <div class="row">
     ...
     <div class="row">
        ...
        <div class="col-md-6 mb-3" style="align-content: center;">
          <label class="mr-sm-2" for="contact">Contact</label><br>
          <input type="text" class="form-control" style="width: 100%;" id="contact" name="contact" value ="<?php echo $contact; ?>" required>
        </div>
     </div>
     ...
     <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <textarea placeholder="Write a description about yourself &#10; Eg. Graduate from IIT-M, Teaching for 15 years,etc" cols="50" rows="5" name="description" ><?php
          include 'db.php';
          $pd=$_SESSION['$pid'];
      ...
      <div class="row" style="align-items: center; width: 100%">
        <button class="button" type="submit" name="submit"><big>UPDATE</big></button>
      </div>
      <br><br>
    </form>
<div style="width: 90%; background-color:#8894a8 ; border-radius: 10px; margin: 10px; padding: 10px;">
...
<?php $_SESSION['$last_page']="facultyinfo.php"; ?>